...
var (
	levelStrings = [...]string{"FNST", "FINE", "DEBG", "TRAC", "INFO", "WARN", "EROR", "MARK"}
)
...
func (log Logger) Log(lvl Level, message string) {
	skip := true
...
// MARK logs a message at the MARK log level and returns the formatted error,
// See Warn for an explanation of the performance and Debug for an explanation
// of the parameters.
func (log Logger) Mark(arg0 interface{}, args ...interface{}) error {
	const (
		lvl = MARK
	)
	var msg string
