...
func Crash(args ...interface{}) {
	if len(args) > 0 {
		Global.intLogf(MARK, strings.Repeat(" %v", len(args))[1:], args...)
	}
	panic(args)
}
...
func Crashf(format string, args ...interface{}) {
	Global.intLogf(MARK, format, args...)
...
func Mark(arg0 interface{}, args ...interface{}) error {
	const (
		lvl = MARK
	)
	switch first := arg0.(type) {
